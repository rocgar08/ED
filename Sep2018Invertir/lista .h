...
public:
	/*
	 Operaci�n 'invertir' a implementar
	 Aparte de este m�todo, puedes implementar otros m�todos (privados) auxiliares
	 que consideres oportunos.
	*/

	/* COMPLEJIDAD:
	 Esta implementación tiene coste lineal porque hay que recorrer toda la lista para ordenar sus punteros
	 */

	void invertir() {
		Nodo* act = _prim;
		Nodo* aSig = NULL, *aAnt = NULL;
	...
	/**
	 Operaci�n a�adida especificamente para el examen.
